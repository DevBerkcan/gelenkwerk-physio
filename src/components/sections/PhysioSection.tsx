        ...
        <div className="py-20 px-8 md:px-12 flex flex-col justify-center">
          ...
          <Reveal delay={0.3}>
            <p className="font-display text-xl leading-relaxed text-brand-muted italic mb-5">
              Unser physiotherapeutisches Angebot umfasst ein breites Spektrum
              an Behandlungen — zur Schmerzlinderung, Verbesserung der
              Beweglichkeit und Förderung der körperlichen Funktion.
            </p>
          </Reveal>

          <Reveal delay={0.4}>
            <p className="font-body text-[15px] leading-relaxed text-brand-muted mb-6">
              Die Therapie richtet sich nach Ihren Beschwerden, Zielen sowie
              ärztlichen Vorgaben. Auch Domizilbehandlungen in Basel sind
              möglich.
            </p>
          </Reveal>
